...
with st.sidebar:
    ...
    st.info("Ask for:\n• 'Create a chart of sales data'\n• 'Show me a table of financial info'\n• 'Visualize the trends'\n• 'Extract key metrics in a table'")
...
# Add footer with enhanced analysis examples
st.markdown("---")
with st.expander("💡 Enhanced Analysis Examples"):
    ...
    **Try these enhanced requests:**
    ...
    - "Visualize the sales performance data"
    - "Generate a graph of the quarterly results"
    
    📋 **Structured Tables:** 
    - "Extract the financial data into a table"
    - "Show me a summary table of key metrics"
    - "Create a comparison table of different products"
    
    📈 **Comprehensive Analysis:** 
    - "Analyze the market trends and show them visually"
    - "Extract insights from the data and create charts"
    - "Provide a complete analysis with tables and visualizations"
    
    💡 **Smart Insights:** 
    - "What are the key findings from this document?"
